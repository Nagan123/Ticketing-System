...
<!-- Send Verification Link Modal: -->
<div class="modal close-after" id="send-vlink">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      <form class="z-form" action="<?php admin_action( 'users/send_vlink' ); ?>" method="post">
        <div class="modal-body">
          <div class="response-message"></div>
          <p><?php echo lang( 'sure_send_vlink' ); ?></p>
        </div>
        <!-- /.modal-body -->
