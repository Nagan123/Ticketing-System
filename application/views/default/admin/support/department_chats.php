      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><?php printf( lang( 'dep_chats_title' ), html_escape( $card_title ) ); ?></h3>
            
            <?php if ( ! $this->zuser->has_permission( 'all_chats' ) ) { ?>
              <p class="ml-2 text-muted float-left text-sm"><?php echo lang( 'assigned_chats_msg' ); ?></p>
            <?php } ?>
          </div>
          <!-- /.card-header -->
