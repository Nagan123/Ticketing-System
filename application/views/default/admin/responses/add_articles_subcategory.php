...
<tr id="record-<?php echo html_escape( $id ); ?>">
  ...
  <td>
    ...
    <span class="text-muted text-sm d-block"><?php echo '/' . html_escape( get_kb_category_slug( $parent_category->slug, $slug ) ); ?></span>
  </td>
  ...
  <td class="text-right">
    <div class="btn-group">
      <a href="<?php echo env_url( html_escape( get_kb_category_slug( $parent_category->slug, $slug ) ) ); ?>" class="btn btn-sm btn-info" target="_blank">
